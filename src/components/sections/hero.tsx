    ...
    <section id="sobre" className="py-16">
      <div
        className="
          ...
          gap-8 md:gap-x-10 md:gap-y-0
          md:items-start
        "
      >
        {/* 1) Apresentação */}
        <div className="order-1 md:order-none md:col-start-1 md:row-start-1 text-center md:text-left max-w-3xl mx-auto md:mx-0 md:mt-12 lg:mt-16">
          <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">
            Olá, eu sou {SITE.name} —{" "}
            <span className="text-primary">{SITE.role}</span>
          </h1>
        </div>
        {/* 2) Foto (logo após no mobile; no desktop ocupa as duas linhas da direita) */}
        ...
        {/* 3) Texto + botão (abaixo do título no desktop) */}
        <div className="order-3 md:order-none md:col-start-1 md:row-start-2 text-center md:text-left max-w-3xl mx-auto md:mx-0">
          <p className="mx-5 my-5 md:mx-0 md:mt-2 md:mb-0">
